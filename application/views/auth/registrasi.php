                ...
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('auth/registrasi'); ?>">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="nim_nip" name="nim_nip"
                                    placeholder="NIM/NIP" value="<?= set_value('nim_nip'); ?>">
                                <?= form_error('nim_nip', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <select class="form-control form-control-user" id="status" name="status">
                                    ...
                                    <option value="1" <?= set_select('status', '1'); ?>>Admin</option>
                                    <option value="2" <?= set_select('status', '2'); ?>>Dosen</option>
                                    <option value="3" <?= set_select('status', '3'); ?>>Mahasiswa</option>
                                </select>
